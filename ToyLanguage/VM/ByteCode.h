...
enum class Instruction : std::uint8_t { NOP, ADD, SUB, MUL, DIV, STOP, PUSH, POP, LOAD_VARIABLE, STORE_VARIABLE, 
  CALLFUNCTION, RETURN, PRINT, PRINTLINE, JUMP_IF_TRUE, JUMP_IF_FALSE, JUMP, COMPARE, ALLOCATE_PTR, READ_PTR, 
  WRITE_PTR, COMPARE_NULL, SWAP
};
